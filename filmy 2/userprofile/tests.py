...
class WatchlistTests(TestCase):
    ...
    def test_watchlist_authenticated(self):
        self.client.login(username='testuser', password='password') #Faz login com as credenciais do usuário.
        response = self.client.get(reverse('Profile')) #Faz uma requisição GET à URL nomeada como 'Profile' (definida no urls.py).
